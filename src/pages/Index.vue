<template>
    <el-container style="height: 100vh;">
        ...
        <el-container>
            <el-aside :width="isCollapse ? '50px' : '175px'" class="aside" style="transition: width 0.2s; display: flex; flex-direction: column; justify-content: space-between; border-right: solid 1px #e6e6e6;">
                <el-menu default-active="1"  :collapse="isCollapse">
                    <el-menu-item index="1" @click="navigator('/index/all')">
                        <div style="display: flex;" >
                            ...
                            <div style="margin-left: 10px;" v-if="!isCollapse">首页</div>
                        </div>
                    </el-menu-item>
                    <el-menu-item index="2" @click="navigator('/index/task')">
                        <div style="display: flex;">
                            ...
                            <div style="margin-left: 10px;" v-if="!isCollapse">任务</div>
                        </div>
                    </el-menu-item>
                    <el-menu-item index="3" @click="navigator('/index/plan')">
                        <div style="display: flex;">
                            ...
                            <div style="margin-left: 10px;" v-if="!isCollapse">计划</div>
                        </div>
                    </el-menu-item>
                    <el-menu-item index="4" @click="navigator('/index/document')">
                        <div style="display: flex;">
                            ...
                            <div style="margin-left: 10px;" v-if="!isCollapse">文档</div>
                        </div>
                    </el-menu-item>
                    <el-menu-item index="5" @click="navigator('/index/collect')">
                        <div style="display: flex;">
                            ...
                            <div style="margin-left: 10px;" v-if="!isCollapse">收藏</div>
                        </div>
                    </el-menu-item>
                    <el-menu-item index="6">
                        <div style="display: flex;">
                            ...
                            <div style="margin-left: 10px;" v-if="!isCollapse">关于</div>
                        </div>
                    </el-menu-item>
                </el-menu>
                <div  style="padding: 10px; border-top: 1px solid #e6e6e6; display: flex; justify-content: center; cursor: pointer;" @click="toggleCollapse">
