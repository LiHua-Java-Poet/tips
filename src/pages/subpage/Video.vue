<template>
    ...
    <el-dialog :title=showTitle :visible.sync="visibleMp4" :close-on-click-modal="false" width="180vh" center :before-close="closeVideo" >
        <div style="width: 100%;display: grid;justify-items: center;">
            <video  ref="videoElement"  style="height: 80vh;" controls :src="visibleMp4"></video>
        </div>
    </el-dialog>
    </div>
</template>
<script>
    ...
    export default{
        ...
        methods:{
            clickItem(obj){
                this.showTitle=obj.file_name
                this.visibleMp4='http://localhost:8083/Preview/previewVideo?file_id='+obj.file_id
            },
            closeVideo(){
                this.visibleMp4=null
                if (this.$refs.videoElement) {  
                    this.$refs.videoElement.pause();  
                    // 还可以将 currentTime 设置为 0 来重置视频播放位置  
