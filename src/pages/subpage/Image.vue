<template>
    ...
    <!-- <el-dialog title="图片预览" :visible.sync="visibleImage" :close-on-click-modal="false" center>
        <div style="width: 100%;display: flex;justify-content: center;">
            ...
            <el-image-viewer  v-if="true" :url-list="imgList" :on-close="closeFunc"/>
        </div>
    </el-dialog> -->
    <el-image-viewer  v-if="visibleImage" :url-list="imgList" :on-close="closeFunc"/>
    </div>
</template>
<script>
    ...
    export default{
        ...
        methods:{
            ...
            itemClick(item){
                this.imgList=[]
                this.imgList.push(item.file_cover)
